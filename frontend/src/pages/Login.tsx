              ...
              {(Object.keys(COUNTRY_CONFIGS) as SupportedCountry[]).filter(code => activeCountries === null || activeCountries.includes(code)).map((code) => {
                ...
                return (
                  <button
                    ...
                    className="w-[calc(33.333%-0.45rem)] flex flex-col items-center justify-center p-2.5 rounded-2xl bg-card border border-border hover:border-primary/50 hover:bg-muted/40 text-foreground transition-all group active:scale-95 shadow-sm"
                  >
