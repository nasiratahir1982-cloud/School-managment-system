...
export const UnifiedDashboard: React.FC = () => {
  ...
  // Visitor Management state - at component level (Rules of Hooks)
  const [editingVisitorId, setEditingVisitorId] = useState<string | null>(null);
  const [editVisitorForm, setEditVisitorForm] = useState<{name:string;cnic:string;phone:string;purpose:string;meetingWith:string;status:string;exitTime:string} | null>(null);
  ...
  const [database, setDatabase] = useState<Record<string, {
    ...
    '33333333-3333-3333-3333-333333333333': {
      ...
      assignments: [
        { id: '1', title: 'Urdu Nazam Analysis', subject: 'Urdu', publishDate: '2026-06-05', dueDate: '2026-06-20', fileName: 'urdu_nazm_task.pdf', fileType: 'pdf', status: 'Published', fileUrl: 'data:application/pdf;base64,' }
      ],
      disciplines: [
    ...
    '44444444-4444-4444-4444-444444444444': {
      ...
      assignments: [
        { id: '1', title: 'GCSE Chemistry Module 3 Worksheet', subject: 'Chemistry', publishDate: '2026-06-06', dueDate: '2026-06-18', fileName: 'chem_module3.pdf', fileType: 'pdf', status: 'Published', fileUrl: 'data:application/pdf;base64,' }
      ],
      disciplines: [
    ...
    '55555555-5555-5555-5555-555555555555': {
      ...
      teachers: [
        ...
        { id: '6', name: 'Sarah OBrien', role: 'Vice Principal', subject: 'Administration', className: 'Admin Block', status: 'Active', salary: '380000', qualification: 'MBA Education', experience: '14 Years', phone: '+971 50 100 1006', email: 'vp@beaconhouse-dxb.edu.ae', gender: 'Female' },
      ...
      assignments: [
        { id: '1', title: 'Arabic Comprehension Exercise', subject: 'Arabic', publishDate: '2026-06-05', dueDate: '2026-06-19', fileName: 'arabic_comp.pdf', fileType: 'pdf', status: 'Published', fileUrl: 'data:application/pdf;base64,' }
      ],
      disciplines: [],
      parentMessages: [
    ...
    '66666666-6666-6666-6666-666666666666': {
      ...
      assignments: [
        { id: '1', title: 'Tafseer Assignment – Surah Al-Baqarah', subject: 'Islamic Studies', publishDate: '2026-06-06', dueDate: '2026-06-20', fileName: 'tafseer_albaqarah.pdf', fileType: 'pdf', status: 'Published', fileUrl: 'data:application/pdf;base64,' }
      ],
      disciplines: [
    ...
    '77777777-7777-7777-7777-777777777777': {
      ...
      teachers: [
        ...
        { id: '4', name: 'Patrick ONeil', role: 'Teacher', subject: 'Mathematics', className: 'Class 9-A', status: 'Active', salary: '225000', qualification: 'M.Sc. Applied Math', experience: '10 Years', phone: '+1 416 555 0104', email: 'p.oneil@rootsintl.ca', gender: 'Male' },
      ...
      assignments: [
        { id: '1', title: 'Civics Assignment – Canadian Government', subject: 'Social Studies', publishDate: '2026-06-06', dueDate: '2026-06-20', fileName: 'civics_govt.pdf', fileType: 'pdf', status: 'Published', fileUrl: 'data:application/pdf;base64,' }
      ],
      disciplines: [
    ...
    '00000000-0000-0000-0000-000000000000': {
      ...
      assignments: [
        { id: '1', title: 'AP US History: Reconstruction Era Essay', subject: 'US History', publishDate: '2026-06-05', dueDate: '2026-06-21', fileName: 'reconstruction_essay.pdf', fileType: 'pdf', status: 'Published', fileUrl: 'data:application/pdf;base64,' }
      ],
      disciplines: [
  ...
  // Advanced Bi-directional Firebase Sync with Loop Prevention
