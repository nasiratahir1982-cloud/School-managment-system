...
protected Titledata;           // document properties
...
function __construct($orientation='P', $unit='mm', $size='A4')
{
	...
	// Titledata
	$this->Titledata = array('Producer'=>'FPDF '.self::VERSION);
...
{
	// Title of document
	$this->Titledata['Title'] = $isUTF8 ? $title : $this->_UTF8encode($title);
}

function SetAuthor($author, $isUTF8=false)
{
	// Author of document
	$this->Titledata['Author'] = $isUTF8 ? $author : $this->_UTF8encode($author);
}

function SetSubject($subject, $isUTF8=false)
{
	// Subject of document
	$this->Titledata['Subject'] = $isUTF8 ? $subject : $this->_UTF8encode($subject);
}

function SetKeywords($keywords, $isUTF8=false)
{
	// Keywords of document
	$this->Titledata['Keywords'] = $isUTF8 ? $keywords : $this->_UTF8encode($keywords);
}

function SetCreator($creator, $isUTF8=false)
{
	// Creator of document
	$this->Titledata['Creator'] = $isUTF8 ? $creator : $this->_UTF8encode($creator);
}
...
protected function _putlinks($n)
{
	foreach($this->PageLinks[$n] as $pl)
	{
		...
		else
		{
			...
			$s .= '/Dest ['.$this->PageInfo[$l[0]]['n'].' 0 R /XYZ 0 %.2F null]>>',$h-$l[1]*$this->k);
		}
		$this->_put($s);
		$this->_put('endobj');
	}
...
protected function _putinfo()
{
	...
	$this->Titledata['CreationDate'] = 'D:'.substr($date,0,-2)."'" . substr($date,-2)."'";
	foreach($this->Titledata as $key=>$value)
